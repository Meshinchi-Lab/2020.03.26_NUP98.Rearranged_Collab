...
colors_abn13 <- c("NUP98-KDM5A" = "magenta1",
                  # "NUP98-KDM5A/del13q" = "mediumorchid4",
                  "NUP98-KDM5A/chr13_abn" = "purple4",
...
XandNSD1_shared.box <- ggplot(XandNSD1_sharedExpn, 
                              aes(x=NUP98.Rearranged.Groups, y=Log2CPM)) +
  geom_point(data = filter(XandNSD1_sharedExpn, !grepl("KDM5A", chr13_Abn_groups)),
             mapping = aes(color=chr13_Abn_groups), 
             position = position_jitter(seed=2021), size=2, alpha=0.75) +
  geom_point(data = filter(XandNSD1_sharedExpn, grepl("KDM5A", chr13_Abn_groups)),
            mapping = aes(color=chr13_Abn_groups, shape=chr13_Abn_groups), 
             position = position_jitter(seed=2021), size=2, alpha=0.75) +
  geom_boxplot(aes(fill = NUP98.Rearranged.Groups), 
               alpha=0.3,outlier.shape = NA, color="black") +
  facet_wrap(~gene) +
...
# ggsave(filename = "TARGET_AML_NUP98.X_NUP98.NSD1_Common_DEGs_boxplot_withChr13Alterations.pdf",
...
XandKDM5A_shared.box <- ggplot(XandKDM5A_sharedExpn, 
                           aes(x=NUP98.Rearranged.Groups, y=Log2CPM)) +
  geom_point(data = filter(XandKDM5A_sharedExpn, !grepl("KDM5A", chr13_Abn_groups)),
             mapping = aes(color=chr13_Abn_groups), 
             position = position_jitter(seed=2021), size=2, alpha=0.75) +
  geom_point(data = filter(XandKDM5A_sharedExpn, grepl("KDM5A", chr13_Abn_groups)),
            mapping = aes(color=chr13_Abn_groups, shape=chr13_Abn_groups), 
...
# ggsave(filename = "TARGET_AML_NUP98.X_NUP98.KDM5A_Common_DEGs_boxplot_withChr13Alterations.pdf",
